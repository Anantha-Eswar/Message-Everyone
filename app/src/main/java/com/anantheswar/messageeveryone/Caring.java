...
public class Caring extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.caring);
        ...
        try {
            ...
            t.setScreenName("Caring Messages");
    ...
    /*    Latest new 1-52
    http://www.desicomments.com/sms/sms/take-care-sms/
     */
    public static String[] messages = {"Learn to only care for the right people in life \n" +
            "because you will realize that some are not worth it."
            ...
            "with much more love, patience, tolerance and care."
            ...
            , "Women are sensitive, \n" +
            "they overthink every little think \n" +
            "and they care way more than they should, \n" +
            "but that's what makes their love so strong."
            , "There is always 1 person in our life\n" +
            "2 whom v give numerous second chances\"\n" +
            "The reason is that, \n" +
            "we don't hate them as much as we love them!!"
            , "Never allow yourself to stop caring. \n" +
            "Feeling too much is better than not feeling enough \n" +
            ...
            "define yourself."
            , "I may not be a clock that may text you 24 hours a day\n" +
            "But my Heart will be like a clock\n" +
            "That will not stop caring \n" +
            "and saying you are always remembered."
            , "When you start caring about yourself, \n" +
            "you start loving somebody.\n" +
            "But when you start caring about others somebody start loving you."
            , "I will always care for you \n" +
            "even if we are far away from each other."
            , "It's hard when someone special ignores you.\n" +
            " It's harder pretending that you just don't care."
            , "The day you stop caring what others think about you is the day you start enjoying life."
            , "I fear that someday,\n" +
            "time would keep us apart \n" +
            "and u might forgot me,\n" +
            "but before it happens I hope that u felt,\n" +
            "even for a single chance\n" +
            "that I have cared for u best way I know!"
            ...
            "not because you always remind them \n" +
            "but just because they care."
            , "In an increasingly impersonal world, \n" +
            "those who show compassion \n" +
            "and caring for others are rare jewels."
            , "A cold hearted person was once a person \n" +
            "who cared too much."
            ...
            "You have gotten dangerously close,\n" +
            "To something called freedom."
            ...
            "even when it seems like you are all alone. \n" +
            "Believe me god is working hard \n" +
            "behind the scenes of your life."
            , "If you genuinely care for someone,\n" +
            "don't ever decorate their eyes with tears, \n" +
            "their ears with lies and their heart with a wound."
            ...
            , "I'm not a pen to write your happiness \n" +
            "but I'll be a nice rubber to erase all your sorrows."
            , "Respect yourself enough to walk away from anything \n" +
            "that no longer serves you, \n" +
            "grows you or makes you happy."
            , "When she worries about you it means she cares, \n" +
            "when she stops caring that's when you should be worried."
            ...
            , "Give because you care not because you want\n" +
            "Love approval or a thankyou in return\n" +
            "True acts of sharing are done\n" +
            "Without an agenda or strings attached."
            ...
            , "No sickness can keep you down with all the prayers. \n" +
            "I offer for your recovery. \n" +
            "Rise up & be strong!"
            , "Stop putting an effort into those who show no effort towards you. \n" +
            "There's only so much you can do before you are wasting your energy and time."
            ...
            "Take Care…"
            , "If i would know that i m gonna die tomorrow, i’ll spend 23 hours with u and if u wonder what about the last hour..in that i’ll find someone who can take care of u…"
            , "Short but great lines:\n" +
            "Unexpected care always keep us happy but\n" +
            "expected care always make us unhappy."
            , "If many people care for u, one of them would be me, if only one person cares for u that would be me again, if no one cares for u that means i’m not in this world.Take Care of u dear.."
            , "I sent my care to the wind\n" +
            "And asked the wind to pass them to you\n" +
            "So when you feel the wind blowing against your face\n" +
            "That’s me saying take care and keep smiling.."
            ...
            "I may b far from U,\n" +
            "But my massages r bridges to make U feel that\n" +
            "I ALWAYS WITH U.\n" +
            "Take C A R E"
            , "The Person who likes You lot\n" +
            "Will Always do to Things Extremely for You\n" +
            "CARING\n" +
            "&\n" +
            "HURTING. . ."
            , "A very good relationship needs just two things,\n" +
            "A little time to be spent wit them and true Care always.."
            , "When we truly care for sum one their mistakes never change our feelings b’coz its the mind that gets angry but the heart still cares 4 them.!"
            ...
            , "The most miserable people are those \n" +
            "who care only about themselves, \n" +
            "understand only their own troubles \n" +
            "& see only their own perspective."};
