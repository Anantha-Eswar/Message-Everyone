...
public class Abbreviation extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            t.setScreenName("Abbreviation Messages");
    ...
    /* Latest new SMS 1-60
    */
    public static String[] messages = {"SMILE:\n" +
            "S: Sets u free,\n" +
            "M: Makes u special,\n" +
            ...
            "S.T.U.D.Y. = Sleeping, Tv, Unlimited-sms, Dreaming, Yawning.\n" +
            "\n" +
            ...
            "N: Nice\n" +
            "D: Days!"
            ,"Never expect loyalty from the professional & practical people, \n" +
            "because they cross all the limits for their fulfillment. \n" +
            "Always trust who is straight forward, \n" +
    ...
    public void randomCopy(View view) {
        ...
        t.send(new HitBuilders.EventBuilder()
                .setCategory("Abbreviation Messages")
